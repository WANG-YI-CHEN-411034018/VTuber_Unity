...
class vtuber():
    ...
    def main(self):
        ...
        if self.cpu: # use dlib to do face detection and facial landmark detection
            import dlib
        ...
        while True:
            ...
            frame_count += 1
            if self.connect and frame_count > 60: # send information to unity
            ...
            if frame_count % 2 == 1: # do face detection every odd frame
                facebox = self.get_face(face_detector, frame, self.cpu)
            ...
            if facebox is not None: # if face is detected
                ...
                if self.cpu: # do detection every frame
                ...
                pitch = np.clip(-(np.degrees(steady_pose[1]))-10, -40, 40) # the 15 here is my camera angle.
                ...
                if self.debug: # draw landmarks, etc.
